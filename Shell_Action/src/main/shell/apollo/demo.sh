...
apollo_config_db_url=jdbc:mysql://10.60.81.148:3306/ApolloConfigDB?characterEncoding=utf8
apollo_config_db_username=root
apollo_config_db_password=123456

# apollo portal db info
apollo_portal_db_url=jdbc:mysql://10.60.81.148:3306/ApolloPortalDB?characterEncoding=utf8
...
# meta server url
config_server_url=http://10.60.81.148:8080
admin_server_url=http://10.60.81.148:8090
eureka_service_url=$config_server_url/eureka/
portal_url=http://10.60.81.148:8070

# JAVA OPTS  -Dnamespace.value.length.limit.override={\"113\":\"100000\"}
BASE_JAVA_OPTS="-Denv=dev -Ddev_meta=$config_server_url  -Dnamespace.value.length.limit.override={\"32\":\"100000\"}" 
